...
/*var qb = [ 24594000,24350000,24250000,22133333,22000000,
		   21900000,21850000,21000000,20812500,20760000,
		   20750000,20500000,19953000,19250000,19000000,
		   18100000,18000000,18000000,18000000,17666667,
		   17500000,17000000,16000000,12000000 ];*/

getQuarterBackAverage();  
function getQuarterBackAverage(){
	var position = [];
	var income = [];

	for(var x = 0; x < data.length; x++){
	
		position.push(data[x].Position);
		income.push(data[x].Income);
	
	}
	
	
	//DECLARATIONS
		var getTotalIncome =0;
		var getAverage;
		var getTotal = 0;
	...
	getAverage = getTotalIncome/getTotal;
